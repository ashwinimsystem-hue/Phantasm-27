...
(function () {
  ...
  const mehendiPattern = /\bmehendi\b|\bmehandi\b|\bmehndi\b|\bhenna\b/i;
  ...
  function isMehendiTile(tile) {
    return mehendiPattern.test(normalize(tile.textContent));
  }
  ...
  function setMaleDisabled(tile) {
    ...
    tile.dataset.phantasmMehendiDisabled = '1';
  ...
  function restoreTile(tile) {
    tile.dataset.phantasmMehendiDisabled = '0';
